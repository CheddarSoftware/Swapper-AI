...
from swapper.typing import Frame
import cv2
from PIL import Image
from swapper.capturer import get_video_frame
...
def get_face_analyser() -> Any:
    ...
    with THREAD_LOCK:
        if FACE_ANALYSER is None:
            FACE_ANALYSER = insightface.app.FaceAnalysis(name='buffalo_l', providers=swapper.globals.execution_providers)
